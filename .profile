...
alias nvim='ln -sf ~/.config/nvim/lua/custom/profiles/packer_compiled_minimal.lua ~/.config/nvim/plugin/packer_compiled.lua; env features=minimal nvim'
alias nvimc='/usr/local/bin/nvim --clean -u ~/.config/nvim/lua/custom/init.default.lua'
